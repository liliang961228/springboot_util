package com.wkk.wkkbjsb.business.module.AppearanceMode.web;

import com.wkk.wkkbjsb.business.module.AppearanceMode.domain.UserInfo;
...
public class HelloWorldController {
    ...
    @RequestMapping(path = "/api/queryUserInfo", method =
            RequestMethod.GET)
//    @DoDoor(key = "userId", returnJson = "⾮⽩名单可访问⽤户拦截!")
